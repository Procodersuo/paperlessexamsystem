                                      ...
                                      MyButton(
                                        ...
                                        onTap: () async {
                                          ...
                                          if (serverTime.isBefore(releaseTime)) {
                                            Get.snackbar("Not Yet", "You can attempt this paper after ${releaseTime.toLocal()}");
                                          } else if (serverTime.isAfter(endTime)) {
                                            Get.snackbar("Expired", "The paper is no longer available (expired at ${endTime.toLocal()})");
                                          } else {
                                            controller.updateControllersFromPaper(paperData);
                                            Get.toNamed("/AttemptingScreen", arguments: paperData);
                                          }
